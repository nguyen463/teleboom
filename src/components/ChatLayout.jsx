        ...
        <div className="relative">
          ...
          {showMenu && (
            <div className="absolute right-0 mt-2 w-48 bg-background border border-border text-foreground rounded-md shadow-lg z-10">
              ...
              {/* ✅ New button for clearing messages */}
              {isOwner && (
                <button
                  onClick={handleClearMessages}
                  className="block w-full text-left px-4 py-2 hover:bg-muted transition-colors text-yellow-500"
                >
                  Clear All Messages
                </button>
              )}
